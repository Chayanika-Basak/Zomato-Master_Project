...
const MobileTabletNavbar = ({ SignIn, SignUp }) => {
    ...
    <div className="flex w-screen items-center justify-between shadow-md p-2 lg:hidden">
        ...
        <button className="bg-coral-400 text-white py-2 px-3 rounded-full">
          Use App
        </button>
        {reduxState?.user?.fullname ? (
          <>
            ...
            <div
              ...
              className="border p-2 border-gray-300 text-coral-400 w-20 h-20 rounded-full"
            >
              <img
          ...
          <>
            <span
              onClick={() => setIsDropDownOpen((prev) => !prev)}
              className="border p-2 border-gray-300 text-coral-400 rounded-full"
            >
              <FaUserAlt />
            </span>
            {isDropDownOpen && (
